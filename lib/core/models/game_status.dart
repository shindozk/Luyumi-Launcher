class GameStatus {
  ...
  final String? latestVersionTimestamp;
  ...
  factory GameStatus.fromJson(Map<String, dynamic> json) {
    return GameStatus(
      ...
      latestVersionTimestamp: json['latestVersionTimestamp'],
      formattedVersion: json['formattedVersion'],
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      'latestVersionTimestamp': latestVersionTimestamp,
