      ...
      child: Column(
        children: [
          ...
          if (currentView != HomeScreenView.home)
            InkWell(
              onTap: () => onViewChanged(HomeScreenView.home),
              child: Container(
                width: 48,
                height: 48,
                decoration: BoxDecoration(
          ...
          _buildSidebarItem(
            ...
            onTap: () => onViewChanged(HomeScreenView.mods),
          ),
          _buildSidebarItem(
            Icons.article_outlined,
            currentView == HomeScreenView.news,
            onTap: () => onViewChanged(HomeScreenView.news),
          ),
          ...
          _buildSidebarItem(
            ...
            onTap: () => onViewChanged(HomeScreenView.settings),
          ),
          const SizedBox(height: 24),
